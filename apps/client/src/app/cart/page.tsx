      ...
      <div className="w-full flex flex-col lg:flex-row gap-16">
        ...
        <div className="w-full lg:w-7/12 shadow-lg border-1 border-gray-100 p-8 rounded-lg flex flex-col gap-8">
          {activeStep === 1 ? (
                ...
                <div className='flex items-center justify-between' key={item.id + item.selectedSize + item.selectedColor}>
                  ...
                  <div className="flex gap-8">
                    ...
                    <div className="relative w-32 h-32 bg-gray-50 rounded-lg overflow-hidden">
                      <Image
                         src={
                           item.images?.[item.selectedColor as keyof typeof item.images] ??
            ...
            ) : activeStep === 3 && shippingForm ? <PaymentForm/> : <p className="text-sm text-gray-500">
              Please fill in the shipping form to continue.</p>}
        </div>
        {/* DETAILS */}
